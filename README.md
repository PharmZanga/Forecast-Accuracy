...
A browser-local dashboard for January–August 2026 family-planning and maternal-health commodity forecast review. Includes executive indicators, programme and month filters, individual commodity trend charts, consumption/forecast/issue/receipt comparisons, detailed monthly tables, stock cover, rules-based actions, multi-file Excel/CSV import, an Excel template and CSV review export.
